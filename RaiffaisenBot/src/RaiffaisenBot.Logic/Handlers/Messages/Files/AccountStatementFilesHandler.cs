...
We regret to inform you that there was an issue processing your file. Errors can occur in the file conversion process.

To assist us in identifying and resolving the problem, please rename your problematic PDF file to ""save_this_for_analysis.pdf"" and upload it again.

Your data is used solely for analysis and code improvement and will not be shared with anyone else.

Your input is valuable in enhancing our bot's performance.";
        private const string FileUploadedMessage
= @"File Uploaded for Analysis

Thank you for submitting your file for analysis. Our team will review it shortly.

Please be patient as we work to process your file. If necessary, we may contact you for further details.

Rest assured, your data will be handled confidentially and used solely for analysis and code optimization.

If you have any additional files to submit or questions, feel free to do so.

We appreciate your contribution in helping us improve our service.";
        ...
        public override async Task<RequestBase<Message>?> HandleAsync(Update update, CancellationToken cancellationToken)
        {
            ...
            if (fileName?.ToLowerInvariant() == "save_this_for_analysis.pdf")
            {
                // todo: save to s3 
                return CreateTextMessage(message.Chat.Id, FileUploadedMessage);
            }
            ...
            fileName = System.IO.Path.GetFileNameWithoutExtension(message.Document.FileName) + ".csv";
            ...
            {
                _logger.LogError(e, "всё плохо");
                return CreateTextMessage(message!.Chat.Id, ErrorMessage);
            }
        }
